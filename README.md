...
| 2014 | Sorzano, Carlos Oscar Sánchez, Javier Vargas, and A. Pascual Montano | A survey of dimensionality reduction techniques | arXiv preprint | 19 methods | [Link](https://arxiv.org/pdf/1403.2877) | arXiv preprint | 
...
| 1969 | Sammon, John W. | A nonlinear mapping for data structure analysis | IEEE Transactions on Computers | Sammon Mapping | [Link](https://ieeexplore.ieee.org/document/1671271) | [Code](https://github.com/tompollard/sammon) |
...
| 2011 | Halko, Nathan, Per-Gunnar Martinsson, and Joel A. Tropp. | Finding structure with randomness: Probabilistic algorithms for constructing approximate matrix decompositions | Randomized PCA | [Link](https://tropp.caltech.edu/papers/HMT11-Finding-Structure.pdf) | [Code](https://scikit-learn.org/stable/modules/generated/sklearn.decomposition.PCA.html) (with method = "randomized") |
...
| 2021 | Narayan, Ashwin, Bonnie Berger, and Hyunghoon Cho | Assessing single-cell transcriptomic variability through density-preserving data visualization | Nature Biotechnology |  | [Link](https://pubmed.ncbi.nlm.nih.gov/33462509/) | [Code](https://github.com/lmcinnes/umap?tab=readme-ov-file#densmap) (with densemap = True) |
